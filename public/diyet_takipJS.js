  function saveDataArsiv(id){
    ...
    if(document.getElementById("checkbox2").checked==true){
      swal({
        title: "Hazırladığınız Beslenme Programını Arşivinize Kaydetmek İstediğinizden Emin Misiniz ?",
        text: "Geri Dönüşü olmayacaktır..",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
...
function saveProgramForAppUser(id){
  if(document.getElementById("checkbox2").checked==true){
      // console.log(updates);
      swal({
        title: "Hazırladığınız Beslenme Programını Danışanınıza Göndermek İstediğinizden Emin Misiniz ?",
        text: "Geri Dönüşü olmayacaktır..",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      ...
      .then((willSave) => {
        if (willSave) {
          ...
          swal("Gönderilme İşlemini İptal Ettiniz");
        }
      });
  }
  else if(document.getElementById("checkbox1").checked==true){
  ...
  archiveRef2.once("value").then(function(snapshot){
    snapshot.forEach(function(childSnapshot){
      ...
      if(proName == child){
        ...
        swal({
          title: "Danışan Beslenme Programını Silmek İstediğinizden Emin Misiniz ?",
          text: "Geri Dönüşü olmayacaktır..",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        ...
        .then((will_delete) => {
          if (will_delete) {
            ...
            swal("Silme İşleminizi İptal Ettiniz..");
          }
        });
      }
    });
  ...
  archiveRef3.once("value").then(function(snapshot){
    snapshot.forEach(function(childSnapshot){
      ...
      if(proName2 == child2){
        ...
        swal({
          title: "Arşivinizde Yer Alan Programı Silmek İstediğinize Emin Misiniz ?",
          text: "Geri Dönüşü olmayacaktır..",
          icon: "warning",
          buttons: true,
          dangerMode: true,
...
function deleteWrongProgram(id){
  ...
  swal({
    title: "Yeni Açmış Olduğunuz Beslenme Programını Silmek İstediğinizden Emin Misiniz ?",
    text: "Geri Dönüşü olmayacaktır..",
    icon: "warning",
    buttons: true,
    dangerMode: true,
...
function updateGeneralProgram(){
  swal({
    title: "Danışan Beslenme Programınızı Güncellemek İstediğinizden Emin Misiniz ?",
    text: "Geri Dönüşü olmayacaktır..",
    icon: "warning",
    buttons: true,
    dangerMode: true,
...
function saveUpdatedGeneralProgramArsiv(){
  swal({
    title: "Danışan Beslenme Programınızı Güncelleyip Arşivinize Kaydetmek İstediğinizden Emin Misiniz ?",
    text: "Geri Dönüşü olmayacaktır..",
    icon: "warning",
    buttons: true,
    dangerMode: true,
  ...
  .then((will_save) => {
    if (will_save) {
        swal("Başarıyla Güncellendi ve Arşivinize Kaydedildi !", {
        icon: "success",
      }).then(function(){
        var urlParams = new URLSearchParams(window.location.search);
        var advisee_user_id = urlParams.get('u');
...
function showDayProgram(id){
  ...
  // console.log(referansday);
    referansday.once("value").then(function(snapshot){
      ...
      labelTitle.innerHTML=program_name+" İsimli Günlük Program";
...
function titleName(){
  ...
  {
    console.log(nameEe);
    document.getElementById("baslık").innerText=nameEe+" Beslenme Programı Takibi";
  });
}
function tog(v){
...
function myFoodDelete(id){
  ...
  swal({
    title: "Besininizi Silmek İstediğinize Emin Misiniz ?",
    text: "",
    icon: "warning",
    buttons: true,
    dangerMode: true,
