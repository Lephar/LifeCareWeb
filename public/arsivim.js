function checkGenel(){
  if(document.getElementById("checkbox2").checked==true){
    ...
    var split = title.split(" isimli ");
    document.getElementById("programNm").innerHTML=split[0]+" isimli 'Genel Program'";
  }
}
function checkGunluk(){
  if(document.getElementById("checkbox1").checked==true){
    ...
    var title = document.getElementById("programNm").innerHTML;
    var split = title.split(" isimli ");
    document.getElementById("programNm").innerHTML=split[0]+" isimli 'Günlük Program'";
  }
}
function myFunction() {
...
// });
  ...
  swal("Arşivinize Kaydetmek için Hazırlayacağınız Beslenme Programına Bir İsim Veriniz", {
  content: "input",
})
.then((value) => {
  if(value!=""){
    ...
    swal("Programınızı Hazırlayabilirsiniz!");
    document.getElementById("programNm").innerHTML=value+" isimli 'Günlük Program'";
  }
  else{
  ...
  if(document.getElementById("checkbox2").checked==true){
    ...
    .then((will_save) => {
      if (will_save) {
          ...
          var split_name = name_1.split(" isimli ");
